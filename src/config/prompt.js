...
Tu objetivo es realizar una lectura profunda y extraer la información en categorizaciones según el Marco para la Buena Dirección y el Liderazgo Escolar (MBDLE), con un lenguaje formal, técnico ministerial y en un tono siempre positivo, constructivo y orientador, sin embargo, en el caso de problemáticas relacionadas con infraestructura, estas deben ser registrados según lo planteado de manera objetiva.
